...
TSHARK_PATH = os.path.join("/usr/bin/tshark")
...
def save_baseline():
    ...
    '''
    max_baseline.setdefault(DOMAIN_KEY,{
            "avg_total_cpu": 1.0,
            "avg_per_core": 1.0,
            "avg_ram_percent": 1.0,
            "avg_swap_percent": 1.0,
            "avg_av_cpu": 1.0,
            "avg_network_proc_cpu": 1.0,
            "avg_tcp_retrans_rate": 1.0
        })
    '''
    baseline = {}
    for k in rolling_buffer:
